package com.uucastle.common.utils.weixin.core;
...
import com.uucastle.common.utils.robot.TuringUtil;
import com.uucastle.common.utils.weixin.aes.AesException;
import com.uucastle.common.utils.weixin.aes.SHA1;
import com.uucastle.common.utils.weixin.aes.WXBizMsgCrypt;
import com.uucastle.common.utils.weixin.enums.EventType;
import com.uucastle.common.utils.weixin.enums.MessageType;
import com.uucastle.common.utils.weixin.exception.WechatRunTimeException;
import com.uucastle.common.utils.weixin.util.StreamTool;
import com.uucastle.common.utils.weixin.vo.MPAccount;
import com.uucastle.common.utils.weixin.vo.event.BasicEvent;
import com.uucastle.common.utils.weixin.vo.event.LocationEvent;
import com.uucastle.common.utils.weixin.vo.event.MenuEvent;
import com.uucastle.common.utils.weixin.vo.event.ScanCodeEvent;
import com.uucastle.common.utils.weixin.vo.event.ScanEvent;
import com.uucastle.common.utils.weixin.vo.event.SendLocationInfoEvent;
import com.uucastle.common.utils.weixin.vo.event.SendPhotosEvent;
import com.uucastle.common.utils.weixin.vo.message.BasicMsg;
import com.uucastle.common.utils.weixin.vo.message.ImageMsg;
import com.uucastle.common.utils.weixin.vo.message.LinkMsg;
import com.uucastle.common.utils.weixin.vo.message.LocationMsg;
import com.uucastle.common.utils.weixin.vo.message.MusicMsg;
import com.uucastle.common.utils.weixin.vo.message.NewsMsg;
import com.uucastle.common.utils.weixin.vo.message.TextMsg;
import com.uucastle.common.utils.weixin.vo.message.VideoMsg;
import com.uucastle.common.utils.weixin.vo.message.VoiceMsg;
import com.uucastle.common.utils.weixin.vo.push.SentAllJobEvent;
import com.uucastle.common.utils.weixin.vo.push.SentTmlJobEvent;
