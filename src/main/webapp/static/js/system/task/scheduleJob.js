	...
	$('#addBtn').on('click', function(e) {
		...
		JY.Model.edit("auDiv","新增任务",function(){
			 if(JY.Validate.form("auForm")){
				 var that =$(this);
				 JY.Ajax.doRequest("auForm",uucpath +'/backstage/task/scheduleJob/add',null,function(data){
		        	that.dialog("close");      
...
function getbaseList(init){
	...
	JY.Model.loading();
	JY.Ajax.doRequest("baseForm",uucpath +'/backstage/task/scheduleJob/findByPage',null,function(data){
...
function check(scheduleJobId){
	cleanForm();
	JY.Ajax.doRequest(null,uucpath +'/backstage/task/scheduleJob/find',{scheduleJobId:scheduleJobId},function(data){
    		setForm(data);
...
function del(scheduleJobId){
	JY.Model.confirm("确认删除吗？",function(){	
		JY.Ajax.doRequest(null,uucpath +'/backstage/task/scheduleJob/del',{scheduleJobId:scheduleJobId},function(data){
	      	 JY.Model.info(data.resMsg,function(){search();});
		});
	});	
}
function edit(scheduleJobId){
	...
	JY.Ajax.doRequest(null,uucpath +'/backstage/task/scheduleJob/find',{scheduleJobId:scheduleJobId},function(data){
    		...
    		JY.Model.edit("auDiv","修改任务",function(){
    			 if(JY.Validate.form("auForm")){
					 var that =$(this);
					 JY.Ajax.doRequest("auForm",uucpath +'/backstage/task/scheduleJob/update',null,function(data){
			        		 that.dialog("close");
			        		 JY.Model.info(data.resMsg,function(){search();});	
					 });
				 }
...
function runOnce(scheduleJobId){
	JY.Model.confirm("确认运行一次吗？",function(){	
		JY.Ajax.doRequest(null,uucpath +'/backstage/task/scheduleJob/runOnce',{scheduleJobId:scheduleJobId},function(data){
	      	 JY.Model.info(data.resMsg,function(){search();});
		});
	});
}
function resumeJob(scheduleJobId){
	JY.Model.confirm("确认启动吗？",function(){	
		JY.Ajax.doRequest(null,uucpath +'/backstage/task/scheduleJob/resumeJob',{scheduleJobId:scheduleJobId},function(data){
	      	JY.Model.info(data.resMsg,function(){search();});
		});
	});
}
function pauseJob(scheduleJobId){
	JY.Model.confirm("确认暂停吗？",function(){	
		JY.Ajax.doRequest(null,uucpath +'/backstage/task/scheduleJob/pauseJob',{scheduleJobId:scheduleJobId},function(data){
	      	 JY.Model.info(data.resMsg,function(){search();});
		});
	});
}
