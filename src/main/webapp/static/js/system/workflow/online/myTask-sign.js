...
function getbaseList(init){
	...
	JY.Model.loading();
	JY.Ajax.doRequest("baseForm",uucpath +'/backstage/workflow/online/myTask/findSignByPage',null,function(data){
...
function claimTask(taskId){
	JY.Model.confirm("确认签收吗？",function(){	
		JY.Ajax.doRequest("",uucpath +'/backstage/workflow/online/myTask/claim/'+taskId,null,function(data){
