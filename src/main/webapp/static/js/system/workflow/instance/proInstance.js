...
function getbaseList(init){
	...
	JY.Model.loading();
	JY.Ajax.doRequest("baseForm",uucpath +'/backstage/workflow/instance/pro/findByPage',null,function(data){
...
function currentNode(pdId,pIId){
	...
	layer.open({
	    ...
	    maxmin: true,
	    area: [width, height],
	    content: uucpath+"/act-process-editor/diagram-viewer/index.html?processDefinitionId="+pdId+"&processInstanceId="+pIId //iframe的url
	});
}
