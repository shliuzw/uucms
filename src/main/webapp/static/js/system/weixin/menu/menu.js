...
function refashMenu(){
	JY.Model.loading();
	$("#menuList").empty();
	JY.Ajax.doRequest(null,uucpath +'/backstage/weixin/menu/menuTree',null,function(data){
...
function findMenu(id){
	cleanForm();
	JY.Model.loading();
	JY.Ajax.doRequest(null,uucpath +'/backstage/weixin/menu/findMenu',{id:id},function(data){
			setForm(data);
...
function addMenu(){
	...
	if(JY.Validate.form("menuForm")){
		 ...
		 $.ajax({type:'POST',url:uucpath+'/backstage/weixin/menu/addMenu',data:JSON.stringify(params),dataType:'json',contentType:"application/json",success:function(data,textStatus){  			        	 
...
function editMenu(){
	...
	if(JY.Validate.form("menuForm")){
		 ...
		 $.ajax({type:'POST',url:uucpath+'/backstage/weixin/menu/updateMenu',data:JSON.stringify(params),dataType:'json',contentType:"application/json",success:function(data,textStatus){  			        	 
        		JY.Model.info(data.resMsg,function(){	
        			cleanForm();
        			refashMenu();	
        			saveBtn="no";
...
function delMenu(){
	JY.Model.confirm("确认要删除菜单吗?",function(){	
		var id=$("#menuForm input[name$='id']").val();
		JY.Ajax.doRequest(null,uucpath +'/backstage/weixin/menu/delMenu',{id:id},function(data){
				JY.Model.info(data.resMsg,function(){
					cleanForm();
					refashMenu();
					saveBtn="no";
...
function syncMenu(){
	JY.Model.confirm("确认要发布菜单吗?",function(){	
		JY.Ajax.doRequest(null,uucpath +'/backstage/weixin/menu/syncMenu',"",function(data){
