...
function sendMail(){
	...
	JY.Model.loading();
	JY.Ajax.doRequest(null,uucpath +'/backstage/tool/email/sendMail',params,function(data){
...
function getbaseList(init){
	...
	JY.Model.loading();
	JY.Ajax.doRequest("baseForm",uucpath +'/backstage/tool/email/findByPage',null,function(data){
		 $("#sentTable").empty();
    		 var obj=data.obj;
        	 var list=obj.list;
...
function getConfig(){
	...
	JY.Model.loading();
	JY.Ajax.doRequest(null,uucpath +'/backstage/tool/email/getConfig',null,function(data){
			var mc=data.obj;
