		...
		<table cellspacing="0" cellpadding="0" border="0" class="customTable">
			<tbody>
				<tr style="display:none">
					<td colspan="2" class="ui-state-error"><input type="hidden" name="fileId" ></td>
				</tr>
				<tr class="FormData" >
				...
				<tr class="FormData">
                    <td class="CaptionTD">录入时间：</td>
                    <td class="DataTD">&nbsp;
						<input name="inputTime" value="" jyValidate="required,datetime" class="date-picker" type="text" placeholder="录入时间" >
					</td>
                </tr>
				<tr class="FormData">
                	<td class="CaptionTD">属性：</td>
                	<td class="DataTD">&nbsp;
                		<span id="selectFileProp"><select name="fileProp" class="chosen-select isSelect105"></select></span>
                	</td>
                </tr>
				<tr class="FormData">
                ...
                <tr class="FormData">
                	<td class="CaptionTD">文号：</td>
                	<td class="DataTD">&nbsp;
                		<input type="text" maxlength="32" name="fileNo" class="FormElement ui-widget-content ui-corner-all isText300">
                	</td>
                </tr>
				<tr class="FormData">
					<td class="CaptionTD"><font color="red">*</font>文件名：</td>
					<td class="DataTD">&nbsp;
						<input type="text" jyValidate="required" maxlength="32" name="fileName" class="FormElement ui-widget-content ui-corner-all isText300">
					</td>
				</tr>
				<tr class="FormData">
