...
<link rel="stylesheet" href="${uucpath}/static/css/system/system/weixin.css" />
</head>
<body>
	...
	<div class="col-sm-4">
		<div class="menu_preview_area">
			<div class="mobile_menu_preview">
				<div class="mobile_hd tc">京缘网络微信平台</div>
				<div class="mobile_bd">
...
<script src="${uucpath}/static/js/system/weixin/menu/menu.js"></script>
</body>
</html>