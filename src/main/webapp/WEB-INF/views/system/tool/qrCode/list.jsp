...
<!-- 二维码引入js -->
<script type="text/javascript" src="${uucpath}/static/js/jquery/jquery.qrcode.min.js"></script>
</head>
<body>
										...
										<div class="widget-box">
											...
											<div class="widget-body">
												<div class="widget-main">
													...
													<div id="code">
														<img id="encoderImgId" cache="false" src="${uucpath}/static/images/system/2qrcodeDefault.png" width="235px" height="235px" />
													</div>
												</div>
											</div>
										</div>
	...
	<script src="${uucpath}/static/js/system/tool/qrcode.js"></script>
</body>
</html>