...
<link rel="stylesheet" href="${uucpath}/static/plugins/webuploader/css/webuploader.css" />
<script src="${uucpath}/static/plugins/webuploader/js/webuploader.nolog.min.js"></script>
</head>
<body>
...
jQuery(function() {
    ...
    uploader = WebUploader.create({
        ...
        auto: true,
        // swf文件路径
        swf: uucpath + '/static/plugins/webuploader/js/Uploader.swf',
        // 文件接收服务端。
        server: uucpath +'/backstage/tool/webuploader/uploadFile',
        // 选择文件的按钮。可选。
