...
<script type="text/javascript" src="${uucpath}/static/plugins/zTree/3.5/jquery.ztree.core-3.5.min.js"></script>
<script type="text/javascript" src="${uucpath}/static/plugins/zTree/3.5/jquery.ztree.excheck-3.5.js"></script>
</head>
<body>
...
<script src="${uucpath}/static/js/system/org/position.js"></script>
</body>
</html>