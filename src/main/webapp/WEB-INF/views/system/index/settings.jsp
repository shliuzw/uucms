    ...
    <div class="tab-content noline tabCenter">
		...
		<div id="proSetting" class="tab-pane">
			  <table  class="customTable">
			  	...
			  	<!-- <tr class="FormData">
					<td>
					<input id="uucastle-settings-navbar" name="fixNavbar" class="ace ace-checkbox-2" type="checkbox">
					<label class="lbl" for="uucastle-settings-navbar"> 固定导航条 <b></b></label>
					</td>
			  	</tr> -->
			  	<!-- <tr class="FormData">
					<td>
					<input id="uucastle-settings-fixMenu" name="fixMenu" class="ace ace-checkbox-2" type="checkbox">
					<label class="lbl" for="uucastle-settings-fixMenu"> 固定菜单栏 <b></b></label>
					</td>
			  	</tr> -->
			  	<tr class="FormData">
					<td>
		...
		<div class="tab-content noline">
			<div class="tab-pane active" id="avatarSetting">
				...
				<div class="row-fluid center">	
					<h4>头像预览</h4>
					<p><img id='headpicPreviewImg' class="headpicPreview" src="${uucpath}/static/images/system/user/hpic1.jpg"></p>
					<p>头像100*100</p>
